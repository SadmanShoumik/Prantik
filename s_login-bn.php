...
<body>
    ...
    <div class="container" align="center">
        <form action="s_login-bn.php" style="height: 400px; width: 700px;" method="POST" class='form-control bg-transparent'>
            <h3 align="center" style="font-weight: bolder; font-size: 40px">বিক্রেতা লগ ইন</h3>
                ...
                if($con)
                {
                    ...
                    while($row=mysqli_fetch_row($res))
                    {
                        if($row[2]==$em && $row[3]==$ps && $row[6]==0)
                        {
                            ...
                            echo '<a style="font-weight: bolder; font-size:40px;" href="seller-bn.php?slogid='.$slogid.'" class="btn btn-success">বিক্রেতার হোম পেজ</a>';
                            $f=1;
                            break;
                        }
                        else if($row[2]==$em && $row[3]==$ps && $row[6]>0)
                        {
                            ...
                            echo '<a style="font-weight: bolder; font-size:40px;" href="sver-bn.php?slogid='.$slogid.'" class="btn btn-success">ভেরিফাই করুন।</a>';
                            $f=1;
                        }
                    }
                    if(!$f){
