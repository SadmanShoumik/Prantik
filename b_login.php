...
<body>
    ...
    <div class="container" align="center">
        <form action="b_login.php" style="height: 400px; width: 700px;" method="POST" class='form-control bg-transparent'>
            <h3 align="center" style="font-weight: bolder; font-size: 40px">Buyer Login</h3>
                ...
                if($con){
                    ...
                    while($row=mysqli_fetch_row($res)){
                        ...
                        else if($row[2]==$em && $row[3]==$ps && $row[6]>0)
                        {
                            ...
                            echo '<a style="font-weight: bolder; font-size:40px;" href="bver.php?slogid='.$slogid.'&pid=0" class="btn btn-success">Verify</a>';
                            $f=1;
                        }
                    }
                    if(!$f){
