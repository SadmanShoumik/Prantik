...
<body>
    ...
    <div align="center">
        <form action="b_reg.php" style="height: 720px; width: 700px;" method="POST" class='form-control bg-transparent'>
            <h3 align="center" style="font-weight: bolder; font-size: 40px">Buyer Registration Form</h3>
        ...
        <?php
            ...
            if(isset($_POST['sub'])){
                ...
                if($con){
                    ...
                    echo '<a class="btn btn-success" style="font-size:35px" href="b_login.php">Buyer Login Page</a>';
                }
