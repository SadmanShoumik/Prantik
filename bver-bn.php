...
<body>
    ...
    <div class="container" align="center">
        <form action="bver-bn.php?slogid=<?php $ssid=$_GET['slogid']; echo $ssid; ?>&pid=0" style="height: 400px; width: 700px;" method="POST" class='form-control bg-transparent'>
            <h3 align="center" style="font-weight: bolder; font-size: 40px">ক্রেতা ভেরিফিকেশন</h3>
            ...
            <input type="submit" class='form-control btn-primary' name='sb' style="font-weight: bolder; font-size: 40px" value='ভেরিফাই'>
        </form>
